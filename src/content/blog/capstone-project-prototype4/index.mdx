...
<div style="display: flex; justify-content: center; gap: 5px;">
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/Zdr7tNJ.png" alt="WS Test" style="width: 100%;"/>
        <figcaption> <i> In the end, it's all part of the learning process and we shall persevere! </i> </figcaption>
    </figure>
</div> 
