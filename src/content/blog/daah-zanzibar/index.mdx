---
title: 'Digital Archive | Mapping Zanzibar 1909'
description: 'Using scans of old newspapers, we were able to discover historical events and trade routes in early 20th century Zanzibar.'
date: 2025-03-12
tags: ['digital-archive']
image: './bg-daah-zanzibar.png'
authors: ['adahafizh']
---
...
| ![Prompt 1.png](./assignment2/prompt_1.png)  |
|---|
| ![Prompt 1.png](./assignment2/prompt_1(2).png)  |
...
<div align="center">
    <figure>
    <img src="assignment2/Map.gif" alt="Route Map" width="640" height="360"/>
    <figcaption>Interactive Map of Zanzibar Shipping Report 1909</figcaption>
    </figure>
</div>
...
<div align="center">
    <figure>
    <img src="assignment2/Graph_Line_Dhows_Sail.png" alt="Route Map"/>
    <figcaption>Dhows Sailed</figcaption>
    </figure>
</div>

<div align="center">
    <figure>
    <img src="assignment2/Graph_Line_Dhows_Arrive.png" alt="Route Map"/>
    <figcaption>Dhows Arrived</figcaption>
    </figure>
</div>
...
# Contributions
*On this assignment, Ahmad prompted the AI chatbots, created the .csv file on Google Sheets, and Dhows graph. Lucas visualized the main table (Shipping Report) into Kepler. We both refined the shipping report table and wrote the markdown post together.*
