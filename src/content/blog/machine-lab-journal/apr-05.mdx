...
```c++ title=".../blog/machine-lab-journal/sketch_apr18a" showLineNumbers=true {3-5, 20-23, 44-45}
#include <Servo.h>
...
<div style="display: flex; justify-content: center; gap: 5px;">
    <figure style="text-align: center;">
        <video width="100%" autoplay loop muted playsinline>
            <source src="https://i.imgur.com/C5TbGrN.mp4" type="video/mp4">
            Your browser does not support the video tag.
            </source>
        </video>
        <figcaption> Tinkercad video demo </figcaption>
    </figure>
</div>
...
<div style="display: flex; justify-content: center; gap: 5px;">
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/Aw4KyE9.png" alt="deck" style="width: 100%;"/>
        <figcaption> This is how I would power it up </figcaption>
    </figure>
</div>

<div style="display: flex; justify-content: center; gap: 5px;"> 
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/YVcv5yO.png" alt="deck" style="width: 100%;"/>
        <figcaption> Found small unused box  </figcaption>
    </figure>
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/aZhWVBr.png" alt="deck" style="width: 100%;"/>
        <figcaption> Added servo motor, feet to short </figcaption>
    </figure>
</div>
...
<div style="display: flex; justify-content: center; gap: 5px;">
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/cjcAAdB.png" alt="deck" style="width: 100%;"/>
        <figcaption> Doesn't power up sadly for some reason? </figcaption>
    </figure>
</div>
