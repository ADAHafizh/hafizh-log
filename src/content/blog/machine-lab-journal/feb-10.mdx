---
title: 'Machine Lab | Feb 10 & 12 2026'
...
<div style="display: flex; justify-content: center; gap: 5px;">
    <figure style="text-align: center;">
        <img src="https://i.imgur.com/tCG1HIn.jpeg" alt="deck" style="width: 100%;"/>
        <figcaption> <i> Circuit Schematics </i></figcaption>
    </figure>
</div>
...
- [DC Motor, Potentiometer, H-Bridge](https://www.instructables.com/Control-DC-Motor-Speed-Using-Potentiometer-L298n-A/)
- [Tinkercad H-Bridge](https://www.tinkercad.com/things/gW8YkiGxEKS-hbridge-basic-)